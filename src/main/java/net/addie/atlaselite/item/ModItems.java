...
public class ModItems {
    ...
    public static final Item SHATTERED_ADDIUM_INGOT = registerItem("shattered_addium_ingot", new Item(new FabricItemSettings()));
    public static final Item ADDIUM_SILK = registerItem("addium_silk", new Item(new FabricItemSettings()));
