...
public enum ModArmorMaterials implements ArmorMaterial {
    ADDIUM_INGOT("addium_ingot", 25, new int[] { 3, 8, 6, 3 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2f, 0.1f, () -> Ingredient.ofItems(ModItems.ADDIUM_INGOT));
    ...
    public String getName() {
        return AtlasElite.MOD_ID + ":" + this.name;
    }
